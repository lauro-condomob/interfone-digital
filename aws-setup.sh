...
echo "2. Execute: sudo sed -i 's/DOMAIN_PLACEHOLDER/seu-dominio.com/g' /etc/nginx/sites-available/interfone"
...
echo "5. Execute: sudo certbot --nginx -d seu-dominio.com -d www.seu-dominio.com"
